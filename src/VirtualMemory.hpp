...
#define SIZE_BITS_PAGE_NUM			(SIZE_BITS_VIRTUAL_ADDR - SIZE_BITS_PAGE_OFFSET)
#define SIZE_BITS_PAGE_OFFSET		(12)
#define WORD_ALIGN_OFFSET			(2)

#define MAX_PAGE_OFFSET				( (SIZE_BITS_PAGE_OFFSET == 32)? (0xFFFFFFFF) : ((1 << SIZE_BITS_PAGE_OFFSET) - 1) )

#define NUM_PAGES_IN_PAGE_TABLE		(POWER_OF_TWO(SIZE_BITS_PAGE_NUM))

#define NUM_BYTES_IN_PAGE			(POWER_OF_TWO(SIZE_BITS_PAGE_OFFSET))
#define NUM_WORDS_IN_PAGE			(POWER_OF_TWO((SIZE_BITS_PAGE_OFFSET - WORD_ALIGN_OFFSET)))
